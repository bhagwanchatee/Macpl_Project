                    ...
                    confirm: function (oEvent) {
                        ...
                        if (aContexts.length) {
                            ...
                            if (isMaterialAlreadySelected) {
                                ...
                                selectedInput.getBindingContext().getObject().NetPrice = selectedValue[0].NetPricewoTax || parseFloat(parseFloat(selectedValue[0].NetAmount)/parseFloat(selectedValue[0].OrderQuantity)||"0.00").toFixed(2);
                                selectedInput.getBindingContext().getObject().isMaterialSelected = true; //enable Item Quantity Input
                                selectedInput.getBindingContext().getObject().DocumentCurrency = selectedValue[0].DocumentCurrency; //enable Item Quantity Input
